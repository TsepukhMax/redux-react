...
type Action = IncrementAction | DecrementAction | UserSelectedAction | UserRemoveSelectedAction | UserStoredAction;
...
const initialState: State = {
  counters: {
    'first': initialCounterState,
    'second': initialCounterState,
  },
...
store.dispatch({type: 'usersStored', payload: {users}} satisfies UserStoredAction);
